...
const DestinationCard = ({destination}) => {
  return (
    <article className='w-full max-w-sm rounded-[24px] overflow-hidden mx-auto relative bg-white cursor-pointer hover:shadow-2xl shadow-md flex flex-col gap-4'>
